...
export class TrendingPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    private http: Http, private cache: CacheService, public snaptomap: SnapToMapProvider, public settings: ThemeSettingsProvider, public networkProvider: NetworkProvider) {
